...
$pdo = new PDO('mysql:host=amirouchbwsallea.mysql.db;dbname=amirouchbwsallea','amirouchbwsallea','Ifocop11',array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,
...
define('URL','http://amirouchecodeur.fr/sallea/');
